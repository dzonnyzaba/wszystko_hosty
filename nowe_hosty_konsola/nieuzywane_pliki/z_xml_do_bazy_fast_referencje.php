...
public function dodajeWyrzuca(array &$tab){
...
$tabelaxml = $nowyxml->tworzTabeleAdresow();
$porownane = $nowyxml->porownanie($tabelaxml);
$tabelka_form = $nowyxml->wyswietlTabeleZPorownania($porownane);
echo $tabelka_form;
//$nowyxml->wyswietlTabeleZPorownania($nowyxml->porownanie());
...
//echo "</pre>";
//echo $nowyxml->wyswietlTabeleZPorownania($obiektadresy);
//$nowyxml->dodajeWyrzuca($obiektadresy);
//echo $nowyxml->wyswietlTabeleZPorownania($obiektadresy);