...
//    }
	...
	//var_dump($this->lista_xmli)."<br>";
        ...
        $sql_tmp = "LOAD DATA LOCAL INFILE 'C:/xampp/htdocs/nowe_hosty/nowe_hosty_konsola/txt/$this->plik_xml_to_txt' IGNORE INTO TABLE tmp 
			FIELDS TERMINATED BY ',' LINES TERMINATED BY '\r\n' (@klucz, nowy_mac, nowy_ip, data, VLAN)";
        $sql_znane = "LOAD DATA LOCAL INFILE 'C:/xampp/htdocs/nowe_hosty/nowe_hosty_konsola/txt/$this->plik_input_conf_to_txt' IGNORE INTO TABLE  znane_hosty
	...
	if(!file_exists('C:/xampp/htdocs/nowe_hosty/nowe_hosty_konsola/stare_pliki_xml/'.$this->dataczas)){
            mkdir('C:/xampp/htdocs/nowe_hosty/nowe_hosty_konsola/stare_pliki_xml/'.$this->dataczas);
	}
